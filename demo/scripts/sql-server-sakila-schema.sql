...
CREATE  PROCEDURE get_actor_by_name
...
--EXEC get_actor_by_name

CREATE FUNCTION gettotalprice (@Price1 DECIMAL, @Price2 DECIMAL)
RETURNS DECIMAL
AS
BEGIN
...
CREATE TRIGGER tri_del_actor ON actor
INSTEAD OF DELETE
AS
 
BEGIN
  RAISERROR ('not possible to delete a actor', 16, 10); 
END
GO
...
ALTER TABLE actor add  phone phonenumber  NOT NULL default '0000'
GO
